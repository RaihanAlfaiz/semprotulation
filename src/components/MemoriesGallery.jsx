...
const memories = [
  {
    ...
    caption: 'masih bingung cari kelas pertama',
    date: 'Semester 1',
    rotation: -2,
  },
  {
    ...
    caption: 'ngerjain tugas mepet deadline',
    date: 'Semester 3',
    rotation: 1.5,
  },
  {
    ...
    caption: 'ketawa padahal lagi stress',
    date: 'Semester 4',
    rotation: -1,
  },
  {
    ...
    caption: 'revisi yang gak ada habisnya',
    date: 'Semester 6',
    rotation: 2,
  },
  {
    id: 5,
    src: '/memories/memory-5.png',
    caption: 'ternyata sekarang udah sempro…',
    date: 'Sekarang',
    rotation: -1.5,
  },
  {
    id: 6,
    src: '/memories/memory-6.png',
    caption: 'nongkrong sambil ngomongin masa depan',
    date: 'Semester 5',
    rotation: 1,
  },
]
    ...
    >
      ...
      <div className="polaroid-frame">
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle, rgba(255,216,155,0.1), transparent 70%)',
            filter: 'blur(12px)',
          }}
        />
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ width: 400, height: 400, top: '5%', left: '0%', opacity: 0.05 }}
      />
      <div
        className="ambient-glow ambient-glow-blush"
        style={{ width: 300, height: 300, bottom: '10%', right: '0%', opacity: 0.04 }}
      />

      {/* Section Header */}
      <motion.div
        ref={headerRef}
        style={{ textAlign: 'center', marginBottom: 'clamp(40px, 5vw, 80px)', position: 'relative', zIndex: 2 }}
      ...
      {/* Gallery Grid */}
      <div className="gallery-grid" style={{ maxWidth: '56rem', margin: '0 auto', position: 'relative', zIndex: 2 }}>
